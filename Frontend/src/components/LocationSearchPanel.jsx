        ...
        <div className="py-5">
          {
           suggestions.map((e,idx)=>(
              // return(
                <div key={idx} onClick={()=>handleSuggestionClick(e)} className="flex gap-4 border-2 p-3 border-grey-50 active:border-black rounded-xl items-center my-2 justify-center">
