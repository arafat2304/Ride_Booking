...
const LookingForDriver = ({setVehicalFound})=>{
    return(
        <div className="w-full">
        <h5 className="absolute p-1 top-0 w-[93%] text-center" onClick={()=>setVehicalFound(false)}><i className="text-3xl ri-arrow-down-wide-line"></i></h5>
