...
const CaptainRiding = () =>{
    ...
    return(
        ...
        <i className="text-lg font-medium ri-logout-box-r-line"></i>
         ...
         <div className="h-4/5  lg:w-1/2 lg:flex-row lg:mx-[300px]">
         {/* <img  className="h-full w-full object-cover" src="https://www.hanbit.co.kr/data/editor/20210429161116_qvzgnfvw.gif" alt="" /> */}
         <LiveTracking/>
         </div>

         <div className="h-1/4 p-6 pt-2 flex justify-between bg-yellow-400  items-center relative  lg:w-1/2 lg:flex-row lg:mx-[300px]" onClick={()=>setFinishRidePanel(true)}>
         <h5 className="absolute p-1 top-0 w-[90%] text-center" onClick={()=>setFinishRidePanel(true)}><i className="text-3xl ri-arrow-up-wide-line"></i></h5>
            <h4 className="font-semibold text-xl">{rideData.distance} Away</h4>
